...
using Avalonia.Themes.KFADynamics.Colors;
using Avalonia.Themes.KFADynamics.Colors.ColorManipulation;
using Avalonia.Themes.KFADynamics.Enums;

namespace Avalonia.Themes.KFADynamics
{
    /// <summary>
    /// Includes the fluent theme in an application.
    /// </summary>
    public class KFADynamicsTheme : Styles
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KFADynamicsTheme"/> class.
        /// </summary>
        /// <param name="sp">The parent's service provider.</param>
        public KFADynamicsTheme(IServiceProvider sp = null)
        {
        ...
        public static readonly StyledProperty<ApplicationTheme> BaseThemeProperty
            = AvaloniaProperty.Register<KFADynamicsTheme, ApplicationTheme>(nameof(BaseTheme));
        ...
        public static readonly StyledProperty<PrimaryColor> PrimaryColorProperty =
            AvaloniaProperty.Register<KFADynamicsTheme, PrimaryColor>(nameof(PrimaryColor));
        ...
        public static readonly StyledProperty<SecondaryColor> SecondaryColorProperty =
            AvaloniaProperty.Register<KFADynamicsTheme, SecondaryColor>(nameof(SecondaryColor));
